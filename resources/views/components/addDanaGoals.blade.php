<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title text-dark" id="addFundsModalLabel">Tambah Dana ke Tujuan: <span id="addFundsGoalName" class="fw-bold"></span></h5>
        ...
        <form id="addFundsForm" method="POST">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="amount_to_add" class="form-label text-dark">Jumlah Dana Ditambahkan (Rp) <span class="text-danger">*</span></label>
                ...
                <div class="mb-3">
                    <label for="add_funds_date" class="form-label text-dark">Tanggal Penambahan Dana <span class="text-danger">*</span></label>
